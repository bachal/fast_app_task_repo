...
//-------------------------------------2nd chart default on page load---------------------------
...
socket.on("response_all_cardss",function(card_dt){
  ...
  for(var i=0;i<card_dt.length;i++){
      str+='<option value="'+card_dt[i]['master_card']+'">'+card_dt[i]['master_card']+'</option>';
  }
...
socket.on("operator_response",function(opr_list){
  ...
  for(var i=0;i<opr_list.length;i++){
               str+='<option value="'+opr_list[i]['Name']+'">'+opr_list[i]['Name']+'</option>';
  }
...
//------------------------2nd chart code end here----------------------------------------------


//-------------------------------chart3 code start here------------------------------------------
...
//----------------------------------chart3 code end here------------------------------

//--------------------------------chart 4th code starts here-----------------------
