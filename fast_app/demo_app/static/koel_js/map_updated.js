...
document.getElementById("stop_job").style.pointerEvents = "none";
document.getElementById("pause_job").style.pointerEvents = "none";
...
function required_data_from_db() {
    ...
    socket.on("received_ids", function (idss) {
        ...
        var position_9_of_5_x = 1290;
        var position_9_of_5_y = 1375;
        var position_10_of_5_x = 1290;
        var position_10_of_5_y = 1570;
        var position_11_of_5_x = 1290;
        var position_11_of_5_y = 1842;
        var position_12_of_5_x = 1290;
        var position_12_of_5_y = 2300;
        var position_13_of_5_x = 1290;
        var position_13_of_5_y = 2410;
        var position_14_of_5_x = 1290;
        var position_14_of_5_y = 2685;
        var position_15_of_5_x = 1290;
        ...
        for (var j = 0; j < required_part_location_1_of_5.length; j++) {
            for (var k = 0; k < ids.length; k++) {
                ...
                if (required_part_location_1_of_5[j] == ids[k]["Location"]) {
                    ...
                    position_1_of_5_x = position_1_of_5_x + 90;
        ...
        for (var j = 0; j < required_part_location_5_of_5.length; j++) {
            for (var k = 0; k < ids.length; k++) {
                ...
                if (required_part_location_5_of_5[j] == ids[k]["Location"]) {
                    ...
                    position_5_of_5_x = position_5_of_5_x + 90;
        ...
        for (var j = 0; j < required_part_location_10_of_5.length; j++) {
            for (var k = 0; k < ids.length; k++) {
                ...
                if (required_part_location_10_of_5[j] == ids[k]["Location"]) {
                    ...
                    position_10_of_5_x = position_10_of_5_x + 90;
        ...
        for (var j = 0; j < required_part_location_11_of_5.length; j++) {
            for (var k = 0; k < ids.length; k++) {
                ...
                if (required_part_location_11_of_5[j] == ids[k]["Location"]) {
                    ...
                    position_11_of_5_x = position_11_of_5_x + 90;
        ...
        for (var j = 0; j < required_part_location_12_of_5.length; j++) {
            for (var k = 0; k < ids.length; k++) {
                ...
                if (required_part_location_12_of_5[j] == ids[k]["Location"]) {
                    ...
                    position_12_of_5_x = position_12_of_5_x + 90;
        ...
        for (var j = 0; j < required_part_location_13_of_5.length; j++) {
            for (var k = 0; k < ids.length; k++) {
                ...
                if (required_part_location_13_of_5[j] == ids[k]["Location"]) {
                    ...
                    position_13_of_5_x = position_13_of_5_x + 90;
        ...
        for (var j = 0; j < required_part_location_14_of_5.length; j++) {
            for (var k = 0; k < ids.length; k++) {
                ...
                if (required_part_location_14_of_5[j] == ids[k]["Location"]) {
                    ...
                    position_14_of_5_x = position_14_of_5_x + 90;
...
//window.onload = required_data_from_db;

function change_required_partlocation() {
    var map_dt = []
    socket.emit("req_map");
    socket.on("map_response", function (map_dt1) {


        sr_number = map_dt1[0]['sr_number'];
        job = map_dt1[0]['job_name'];
        apl_code = map_dt1[0]['apl'];
        document.getElementById("reports").id = job + ',' + apl_code + ',' + sr_number;
        var parts = map_dt1[0]['partlist']
        ...
        for (var j = 0; j < pt.length; j++) {
            if (pt[j]['Status'] == "Not picked") {
                ...
                for (key in myFeatureGroup._layers) {
                    if (myFeatureGroup._layers[key]['test'] == pt[j]['SV ID']) {
                        //myFeatureGroup._layers[key]._icon.clientHeight
                        //myFeatureGroup._layers[key]._icon.clientWidth
                        var loc;
                        if (myFeatureGroup._layers[key]._icon.clientWidth < 50) {


                            loc = pt[j]['Pickup Location'].slice(-2);
                            var svg = '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="13" height="13" style="fill:red" viewBox="0 0 ' + myFeatureGroup._layers[key]._icon.clientWidth + myFeatureGroup._layers[key]._icon.clientHeight + '"><rect width="13" height="13" style="" /><text x="3" y="10" fill="white" font-size="7" font-weight="700">' + loc + '</text></svg>'
                            ...
                            loc = pt[j]['Pickup Location'];
                            var svg = '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid meet" viewBox="0 0 ' + myFeatureGroup._layers[key]._icon.clientWidth + ' ' + myFeatureGroup._layers[key]._icon.clientHeight + ' " width="' + myFeatureGroup._layers[key]._icon.clientWidth + '" height="' + myFeatureGroup._layers[key]._icon.clientHeight + '" id="" fill="red"><defs><path d="M0 0L50 0L50 36L0 36L0 0Z" id="d1HwhFdh0a" ></path><text id="edJQPl1YZ" x="3.19" y="1.83" font-size="5" font-family="Open Sans" font-weight="700" font-style="normal" letter-spacing="0" alignment-baseline="before-edge" transform="matrix(1 0 0 1 -1.7462686567164205 -1.335820895522378)" style="line-height:100%" xml:space="preserve" dominant-baseline="text-before-edge"><tspan x="3.19" dy="0em" alignment-baseline="before-edge" dominant-baseline="text-before-edge" text-anchor="start" id="t_span">' + loc + '</tspan></text><style id="opensans700normal"></style></defs><g><g><g><g></g><use xlink:href="#d1HwhFdh0a" opacity="1" fill-opacity="1"></use></g><g id="bv4yYAEIG"><use xlink:href="#edJQPl1YZ" opacity="1" fill="#ffffff" fill-opacity="1"></use></g></g></g></svg>'
                        ...
                        var newIcon = L.icon({
                            iconUrl: svg_url,
                            color: "red",
                            iconSize: [myFeatureGroup._layers[key]._icon.clientWidth, myFeatureGroup._layers[key]._icon.clientHeight]
                            //iconSize:[50,15]
                        });
                        myFeatureGroup._layers[key].setIcon(newIcon);
                        //myFeatureGroup._layers[key].off('click', groupClick);

                        // myFeatureGroup._layers[key]._icon.className='leaflet-marker-icon leaflet-zoom-animated leaflet-interactive redbox';
                        //className: "leaflet-marker-icon leaflet-zoom-animated leaflet-interactive"

                        //myFeatureGroup._layers[key]._icon.DomUtil.addClass(marker._icon, 'redbox');
                ...
                for (key in myFeatureGroup._layers) {
                    if (myFeatureGroup._layers[key]['test'] == pt[j]['SV ID']) {
                        ...
                        if (myFeatureGroup._layers[key]._icon.clientWidth < 50) {
                            ...
                            var svg = '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="13" height="13" style="fill:#5EF507" viewBox="0 0 ' + myFeatureGroup._layers[key]._icon.clientWidth + myFeatureGroup._layers[key]._icon.clientHeight + '"><rect width="13" height="13" style="" /><text x="3" y="10" fill="white" font-size="7" font-weight="700">' + loc + '</text></svg>'
                            ...
                            loc = pt[j]['Pickup Location'];
                            var svg = '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid meet" viewBox="0 0 ' + myFeatureGroup._layers[key]._icon.clientWidth + ' ' + myFeatureGroup._layers[key]._icon.clientHeight + ' " width="' + myFeatureGroup._layers[key]._icon.clientWidth + '" height="' + myFeatureGroup._layers[key]._icon.clientHeight + '" id="" fill="#5EF507"><defs><path d="M0 0L50 0L50 36L0 36L0 0Z" id="d1HwhFdh0a" ></path><text id="edJQPl1YZ" x="3.19" y="1.83" font-size="5" font-family="Open Sans" font-weight="700" font-style="normal" letter-spacing="0" alignment-baseline="before-edge" transform="matrix(1 0 0 1 -1.7462686567164205 -1.335820895522378)" style="line-height:100%" xml:space="preserve" dominant-baseline="text-before-edge"><tspan x="3.19" dy="0em" alignment-baseline="before-edge" dominant-baseline="text-before-edge" text-anchor="start" id="t_span">' + loc + '</tspan></text><style id="opensans700normal"></style></defs><g><g><g><g></g><use xlink:href="#d1HwhFdh0a" opacity="1" fill-opacity="1"></use></g><g id="bv4yYAEIG"><use xlink:href="#edJQPl1YZ" opacity="1" fill="#ffffff" fill-opacity="1"></use></g></g></g></svg>'
                        ...
                        myFeatureGroup._layers[key].setIcon(newIcon2);
                    }
                }//end inner for loop
            }//end outer if loop
...
function groupClick(event) {
    ...
    for (var k = 0; k < ids.length; k++) {
        if (svg == ids[k]["SV ID"]) {
            live_loc = ids[k]["Live_Location"]
        }//end if loop
    }//end inner for loop
    add_live_loc(given_lat, given_lng, live_loc)

    // console.log(document.getElementById("msg").innerText);
    var partlist_array = part_given_data
    for (var k = 0; k < partlist_array.length; k++) {
        svg_ids_list.push(partlist_array[k]['SV ID'])
    }
    var present = svg_ids_list.indexOf(svg) > -1
    if (present) {
        if (document.getElementById("msg").innerText == "Job started") {

            document.getElementById('modal').click();
            //add_new(given_lat,given_lng);
        }

        //L.marker([1265, 1200]).addTo(map);
        var c = -1;

        do { c = c + 1; }
        while (svg != partlist_array[c]['SV ID']);
        part_sv_id = partlist_array[c]['SV ID'];
        pickup_location = partlist_array[c]['Pickup Location'];
        part_descri = partlist_array[c]['Part Description'];
        part_number = partlist_array[c]['Part Number'];
        qty = partlist_array[c]['Qty'];
        part_sr = partlist_array[c]['Serial No'];
        status = partlist_array[c]['Status'];
        live_loc = partlist_array[c]['Live_Location'];
        // console.log("selected part data");
        // console.log(partlist_array[c]);
    ...
    for (var k = 0; k < ids.length; k++) {
        if (pickup_location == ids[k]["Location"]) {
            live_loc = ids[k]["Live_Location"]
        }//end if loop
    }//end inner for loop
    // add_live_loc(given_lat,given_lng,live_loc)
...
//if user any part update means part pick then this function worked on status change
...
//--------------------------------------if parts picked the give response from backend ---------------------------------------
socket.on("update_response", function (dt) {
    // console.log("selected_dt");
    // console.log(dt);
    for (key in myFeatureGroup._layers) {
        if (myFeatureGroup._layers[key]['test'] == dt['sv_id']) {
            if (myFeatureGroup._layers[key]._icon.clientWidth < 50) {


                loc = dt['location'].slice(-2);
                var svg = '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="13" height="13" style="fill:#5EF507" viewBox="0 0 ' + myFeatureGroup._layers[key]._icon.clientWidth + myFeatureGroup._layers[key]._icon.clientHeight + '"><rect width="13" height="13" style="" /><text x="3" y="10" fill="white" font-size="7" font-weight="700">' + loc + '</text></svg>'
            ...
            //var svg='<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid meet" viewBox="0 0 '+myFeatureGroup._layers[key]._icon.clientWidth+ ' '+myFeatureGroup._layers[key]._icon.clientHeight+' " width="'+myFeatureGroup._layers[key]._icon.clientWidth +'" height="'+myFeatureGroup._layers[key]._icon.clientHeight+'" id="" fill="#5EF507"><defs><path d="M0 0L50 0L50 36L0 36L0 0Z" id="d1HwhFdh0a" ></path><text id="edJQPl1YZ" x="3.19" y="1.83" font-size="5" font-family="Open Sans" font-weight="700" font-style="normal" letter-spacing="0" alignment-baseline="before-edge" transform="matrix(1 0 0 1 -1.7462686567164205 -1.335820895522378)" style="line-height:100%" xml:space="preserve" dominant-baseline="text-before-edge"><tspan x="3.19" dy="0em" alignment-baseline="before-edge" dominant-baseline="text-before-edge" text-anchor="start" id="t_span">'+dt['location']+'</tspan></text><style id="opensans700normal"></style></defs><g><g><g><g></g><use xlink:href="#d1HwhFdh0a" opacity="1" fill-opacity="1"></use></g><g id="bv4yYAEIG"><use xlink:href="#edJQPl1YZ" opacity="1" fill="#ffffff" fill-opacity="1"></use></g></g></g></svg>'
            const blob = new Blob([svg], { type: 'image/svg+xml' });
            const svg_url = URL.createObjectURL(blob);
            var newIcon = L.icon({
                iconUrl: svg_url,
...
// ---------------------------------------------change part location color code end---------------------------------------
//--------------------------------------------- old code start and stop-------------------------------------------------

function get_start_time() {

    //socket.emit("req_map")
    document.getElementById("stop_job").style.pointerEvents = "all";
    document.getElementById("pause_job").style.pointerEvents = "all";
    update_time = {}
    ...
    //document.getElementById("svg121753").style.pointer-events= "all";
...
function get_end_time() {
    ...
    //document.getElementById("play_job").disabled = true;
    document.getElementById("play_job").style.pointerEvents = "none";
    document.getElementById("pause_job").style.pointerEvents = "none";
